...
public class MyController {
	 ...
	 * 		절대 허용하지 않는다
	 * 
	 * RequestMapping이 같더라고 RequestMethod가 다르면 
	 * 		같이 사용할 수 있다.
	 * 
	 ...
	 * 전달받은 변수이름과 Java mothod의 매개변수와 이름매칭방법으로
	 * 변수를 받는다
	 * 이런코드는 개발자가 신경쓰지 않아도 자동으로
	 * 작동되는 코드이다
	 ...
	 *		Reflection 코드가 중단되고
	 *		Spring의 Dispatcher은 Web 400 Status Code를
	 *		응답해 버린다
	 *
