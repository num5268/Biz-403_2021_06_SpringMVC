...
public class HomeController {
	...
	// 주소창에 직접입력하고 Enter를 눌렀을때
	//		localhost:8080/rootPath/dumy/gallery/detail
	// location.href=${rootPath}/dumy/gallery/detail 로 JS에서
	//		실행했을때
//	@RequestMapping(value="/dumy/gallery/detail/{id}", method=RequestMethod.GET)
//	public String dumy() {
//		return "home";
//	}
	/*
...
//	}
//	
	// localhost:8080/rootPath/dumy/gallery/image 요청했을때
	// Request를 처리할 method
